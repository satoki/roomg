...
### フレーム単位のノイズ
[手法](#手法)で使用した[sample_01.mp4](tools/sample_01.mp4)をフレーム単位で分割し、1つのフレームのバーチャル背景部分を[ノイズ](tools/image_123.png)に変更したものを再度動画にした[sample_03.mp4](tools/sample_03.mp4)にroomgを適用する。  
